...
function ChevronBack() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <path d="M15 18l-6-6 6-6" stroke={C.name} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
      ...
      <header style={{
        ...
        <button
          ...
          style={{
            ...
            minWidth: 48, minHeight: 48, margin: -12, padding: 12,
        ...
        <span style={{ fontSize: 18, fontWeight: 700, color: C.accent, letterSpacing: '-0.3px' }}>TASKCASH</span>
