...
export default function ProfileSettingsPage() {
    ...
    return (_jsxs("div", { className: "page", style: { background: C.bg }, children: [_jsx(AppHeader, { title: "TASKCASH", showBack: true, onBack: () => navigate('/profile') }), _jsxs("div", { className: "scroll-area", style: { padding: '24px 16px' }, children: [_jsx("h2", { style: {
                            fontSize: 12, fontWeight: 700, color: C.label,
                            letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 16,
                        }, children: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438 \u043F\u0440\u043E\u0444\u0438\u043B\u044F" }), _jsx("h3", { style: { fontSize: 12, fontWeight: 700, color: C.label, marginBottom: 10 }, children: "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F" }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 24 }, children: [
                            { key: 'notify_tasks', label: 'Награды за задания' },
                            { key: 'notify_withdrawals', label: 'Вывод средств' },
                            { key: 'notify_referrals', label: 'Реферальные бонусы' },
                        ].map(({ key, label }) => (_jsxs("div", { style: {
                                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                                padding: '12px 16px', background: '#E2F3EE', borderRadius: 12,
                            }, children: [_jsx("span", { style: { fontSize: 14, color: C.name }, children: label }), _jsx("button", { type: "button", disabled: notifyLoading, onClick: () => toggleNotify(key), style: {
                                        ...
                                        } }) })] }, key))) }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: 8 }, children: items.map((item, i) => (_jsxs("button", { type: "button", onClick: item.onClick, style: {
                                ...
                                cursor: 'pointer', textAlign: 'left', minHeight: 48,
                                            ...
                                            }, children: item.label }), 'subtitle' in item && item.subtitle && (_jsx("div", { style: { fontSize: 12, color: C.label, marginTop: 2 }, children: item.subtitle }))] }), _jsx(ChevronRight, {})] }, i))) }), _jsx("button", { type: "button", onClick: () => setShowDeleteModal(true), style: {
                            background: 'none', border: 'none', color: '#EF4444',
                            fontSize: 13, cursor: 'pointer', width: '100%',
                            padding: '14px 0', textAlign: 'center', marginTop: 24,
                        }, children: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442" })] }), showDeleteModal && (_jsx("div", { style: {
                    position: 'fixed', inset: 0, zIndex: 200,
                    background: 'rgba(0,0,0,0.2)',
                    backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    padding: '0 24px',
                }, onClick: () => setShowDeleteModal(false), children: _jsxs("div", { style: {
                        width: '100%', maxWidth: 340,
                        background: C.white, borderRadius: 20,
                        padding: '28px 24px 24px', position: 'relative',
                    }, onClick: (e) => e.stopPropagation(), children: [_jsx("button", { onClick: () => setShowDeleteModal(false), style: {
                                position: 'absolute', top: 16, right: 16,
                                width: 28, height: 28, borderRadius: '50%',
                                border: 'none', background: C.bg,
                                fontSize: 16, cursor: 'pointer', color: C.label,
                            }, children: "\u00D7" }), _jsx("p", { style: { fontSize: 18, fontWeight: 700, color: C.name, marginBottom: 12 }, children: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442" }), _jsx("p", { style: { fontSize: 13, color: C.label, lineHeight: 1.5, marginBottom: 24 }, children: "\u0412\u044B \u0443\u0432\u0435\u0440\u0435\u043D\u044B, \u0447\u0442\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u0443\u0434\u0430\u043B\u0438\u0442\u044C \u0432\u0430\u0448 \u0430\u043A\u043A\u0430\u0443\u043D\u0442? \u0412\u0441\u0435 \u0434\u0430\u043D\u043D\u044B\u0435 \u043D\u0430 \u0432\u0430\u0448\u0435\u043C \u0430\u043A\u043A\u0430\u0443\u043D\u0442\u0435 \u0431\u0443\u0434\u0443\u0442 \u0443\u0434\u0430\u043B\u0435\u043D\u044B \u0431\u0435\u0437 \u0432\u043E\u0437\u0432\u0440\u0430\u0442\u0430." }), _jsx("button", { onClick: () => setShowDeleteModal(false), style: {
                                width: '100%', height: 48, borderRadius: 24, border: 'none',
                                background: GRAD, color: C.white, fontWeight: 700, fontSize: 15,
                                cursor: 'pointer', marginBottom: 14,
                            }, children: "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C" }), _jsx("div", { style: { textAlign: 'center' }, children: _jsx("button", { onClick: async () => {
                                    try {
                                ...
                                }, children: "\u0423\u0434\u0430\u043B\u0438\u0442\u044C" }) })] }) })), showLogoutModal && (_jsx("div", { style: {
                    position: 'fixed', inset: 0, zIndex: 200,
                    background: 'rgba(0,0,0,0.2)',
                    backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    padding: '0 24px',
                }, onClick: () => setShowLogoutModal(false), children: _jsxs("div", { style: {
                        width: '100%', maxWidth: 340,
                        background: C.white, borderRadius: 20,
                        padding: '28px 24px 24px', position: 'relative',
                    }, onClick: (e) => e.stopPropagation(), children: [_jsx("button", { onClick: () => setShowLogoutModal(false), style: {
                                position: 'absolute', top: 16, right: 16,
                                width: 28, height: 28, borderRadius: '50%',
                                border: 'none', background: C.bg,
                                fontSize: 16, cursor: 'pointer', color: C.label,
                            }, children: "\u00D7" }), _jsx("p", { style: { fontSize: 18, fontWeight: 700, color: C.name, marginBottom: 12 }, children: "\u0412\u044B\u0439\u0442\u0438" }), _jsx("p", { style: { fontSize: 13, color: C.label, lineHeight: 1.5, marginBottom: 24 }, children: "\u0412\u044B \u0443\u0432\u0435\u0440\u0435\u043D\u044B, \u0447\u0442\u043E \u0445\u043E\u0442\u0438\u0442\u0435 \u043F\u043E\u043A\u0438\u043D\u0443\u0442\u044C \u0441\u0435\u0440\u0432\u0438\u0441?" }), _jsx("button", { onClick: () => { logout(); navigate('/login'); setShowLogoutModal(false); }, style: {
                                width: '100%', height: 48, borderRadius: 24, border: 'none',
                                background: '#EF4444', color: C.white, fontWeight: 700, fontSize: 15,
                                cursor: 'pointer', marginBottom: 14,
                            }, children: "\u0412\u044B\u0439\u0442\u0438" }), _jsx("div", { style: { textAlign: 'center' }, children: _jsx("button", { onClick: () => setShowLogoutModal(false), style: {
                                    background: 'none', border: 'none', cursor: 'pointer',
                                    fontSize: 14, fontWeight: 600, color: C.accent,
                                }, children: "\u041E\u0442\u043C\u0435\u043D\u0438\u0442\u044C" }) })] }) })), openDocId && getDocumentById(openDocId) && (_jsx(DocumentView, { document: getDocumentById(openDocId), onClose: () => setOpenDocId(null), backLabel: "\u0417\u0430\u043A\u0440\u044B\u0442\u044C" }))] }));
}
