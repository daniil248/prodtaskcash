...
function userDisplayName(w: Withdrawal): string {
              ...
              <tr key={w.id}>
                ...
                <td>
                  <button
                    type="button"
                    className="btn-link"
                    onClick={() => navigate('/users', { state: { openUserId: w.user_id } })}
                    style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontWeight: 600, color: 'var(--accent)', textAlign: 'left' }}
                  >
                    {userDisplayName(w)}
                  </button>
                  <div className="text-muted text-sm">ID {w.user_id}{w.user_telegram_id != null ? ` · TG ${w.user_telegram_id}` : ''}</div>
                </td>
              ...
              <div>
                ...
                <div className="mc-sub">
                  ...
                  <button
                    type="button"
                    onClick={() => navigate('/users', { state: { openUserId: w.user_id } })}
                    style={{ background: 'none', border: 'none', padding: 0, cursor: 'pointer', fontWeight: 600, color: 'var(--accent)', textDecoration: 'underline' }}
                  >
                    {userDisplayName(w)}
                  </button>
                </div>
